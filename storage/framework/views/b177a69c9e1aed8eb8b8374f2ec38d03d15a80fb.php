...
<?php $__env->startSection('title', "Editar Usuário - $supplier->name"); ?>
<?php $__env->startSection('content'); ?>
  <div class="page-title-container">
    ...
    <div class="page-text">
      <div class="page-title"><?php echo e($supplier->name); ?><span>Editar Fornecedor</span></div>
  ...
  <div class="form-container">
    ...
    <form action="/suppliers/<?php echo e($supplier->id); ?>" class="page" method="POST">
      <?php echo csrf_field(); ?>
      ...
      <div class="row"> <!-- name, cnpj, ie -->
        ...
        <div class="group grid-size-3"> <!-- cnpj input -->
          ...
          <input type="text" 
            ...
            id="cnpj" 
            class="field border-bottom-primary"
            value="<?php echo e($supplier->cnpj); ?>"
      ...
      <div class="row"> <!-- company -->
        <div class="group grid-size-10">
          ...
          <input type="text" 
            ...
            id="company"
            class="field border-bottom-primary"
            value="<?php echo e($supplier->company); ?>"
      ...
      <div class="row"> <!-- email, phone -->
        <div class="group grid-size-3"> <!-- phone1 input -->
          ...
          <input type="text" 
            ...
            id="phone1" 
            class="field border-bottom-primary"
            value="<?php echo e($supplier->phone1); ?>"
        ...
        <div class="group grid-size-3"> <!-- phone2 input -->
          ...
          <input type="text" 
            ...
            id="phone2" 
            class="field border-bottom-primary"
            value="<?php echo e($supplier->phone2); ?>"
      ...
      <div class="row"> <!-- address -->
        ...
        <div class="group grid-size-1"> <!-- address_number input -->
          ...
          <input type="text" 
            ...
            id="address_number" 
            class="field border-bottom-primary"
            value="<?php echo e($supplier->address_number); ?>"
        ...
        <div class="group grid-size-3"> <!-- neighborhood input -->
          ...
          <input type="text" 
            ...
            id="neighborhood" 
            class="field border-bottom-primary"
            value="<?php echo e($supplier->neighborhood); ?>"
            placeholder="Bairro">
      ...
      <div class="row"> <!-- cep, city, uf -->  
        <div class="group grid-size-4"> <!-- city input -->
          ...
          <input type="text" 
            ...
            id="city" 
            class="field border-bottom-primary"
            value="<?php echo e($supplier->city); ?>"
            placeholder="Cidade">
        </div> <!-- end city input -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeManager\resources\views/suppliers/editSupplier.blade.php ENDPATH**/ ?>