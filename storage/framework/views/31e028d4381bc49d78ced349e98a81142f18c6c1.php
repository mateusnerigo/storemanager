...
<?php $__env->startSection('content'); ?>
  <div class="page-title-container">
    ...
    <div class="page-text">
      <div class="page-title">Cadastrar cliente</div>
      <div class="page-description">Cadastre um novo cliente preenchendo os dados abaixo</div>
    </div>
  </div>

  <form action="/clients" class="page" method="post">
    <?php echo csrf_field(); ?>
    <div class="row">
    ...
    <div class="button-field">
      <a href="/clients" class="btn btn-neutral">Cancelar</a>
      <button class="btn btn-primary">Criar</button>
    </div>
  </form>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeManager\resources\views/clients/newClient.blade.php ENDPATH**/ ?>